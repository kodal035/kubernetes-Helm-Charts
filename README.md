...
extra information 
```bash
kubectl create deployment mynginx --image=nginx --dry-run=client -o yaml > mynginx.yaml 
kubectl expose deploy mynginx --port=80 --dry-run=client -o yaml > mynginx-service.yaml
